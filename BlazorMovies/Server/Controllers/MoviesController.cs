...
namespace BlazorMovies.Server.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Movie>>> Filter(FilterMoviesDTO filterMoviesDTO)
        {
            ...
            await HttpContext.InsertPaginationParametersInResponse(moviesQueryabale, 
        ...
        public async Task<ActionResult<IndexPageDTO>> Get()
        {
            ...
            response.Intheatres = moviesInTheaters;
        ...
        public async Task<ActionResult> Put(Movie movie)
        {
            ...
            if (!string.IsNullOrWhiteSpace(movie.Poster))//null means that person does't want to update the picture of the person
            {
                ...
                movieDB.Poster = await fileStorageService.EditFile(moviePoster, "jpeg", containerName, movieDB.Poster);
            }
